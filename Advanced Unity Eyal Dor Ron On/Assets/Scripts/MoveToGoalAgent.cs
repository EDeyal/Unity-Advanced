...
public class MoveToGoalAgent : Agent
{
    ...
    {
        transform.localPosition = new Vector3(Random.Range(-3,3f),0,Random.Range(-3,3f));
        targetTransform.localPosition = new Vector3(Random.Range(-3f,3f),0,Random.Range(-3,3f));
    }
